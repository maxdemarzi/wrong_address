...
public class Exceptions extends WebApplicationException {
    ...
    public static Exceptions missingAddressParameter = new Exceptions(400, "Missing Address Parameter.");
    public static Exceptions invalidAddressParameter = new Exceptions(400, "Invalid Address Parameter.");
